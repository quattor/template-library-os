...
template rpms/errata/20100618-fix;
...
'/software/packages'=pkg_repl('nss','3.12.6-1.el4_8','i386');
'/software/packages'=pkg_repl('nss','3.12.6-1.el4_8','x86_64');
'/software/packages'=pkg_del('seamonkey-nspr');
'/software/packages'=pkg_repl('nspr','4.8.4-1.1.el4_8','i386');
'/software/packages'=pkg_repl('nspr','4.8.4-1.1.el4_8','x86_64');
