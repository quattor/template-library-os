template rpms/errata/20110407-fix;
...
'/software/packages'= if(
  ...
  pkg_repl('libsmbclient','3.0.33-3.29.el5_6.2','x86_64');
} else {
 SELF;
};
...
'/software/packages'= if(
        ...
        pkg_del('tzdata');
        pkg_repl('tzdata','2011d-3.el5','x86_64');
} else {
        SELF;
};
...
'/software/packages'= if (
        ...
        pkg_repl('freetype-devel','2.2.1-28.el5_5.1','x86_64');
        ...
        pkg_repl('pango-devel','1.14.9-8.el5_6.2','x86_64');
...
'/software/packages'= if(
        exists(SELF[escape('python')])
) {
        pkg_repl('python-libs','2.4.3-43.el5','x86_64');
} else {
        SELF;
};
