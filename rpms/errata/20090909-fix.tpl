...
template rpms/errata/20090909-fix;
...
'/software/packages'=pkg_repl('nss','3.12.3.99.3-1.el4_8.2','i386');
'/software/packages'=pkg_repl('nss','3.12.3.99.3-1.el4_8.2','x86_64');
'/software/packages'=pkg_del('seamonkey-nspr');
'/software/packages'=pkg_repl('nspr','4.7.4-1.el4_8.1','i386');
'/software/packages'=pkg_repl('nspr','4.7.4-1.el4_8.1','x86_64');
...
'/software/packages'=pkg_repl('evolution28-pango','1.14.9-11.el4_7',PKG_ARCH_DEFAULT);
