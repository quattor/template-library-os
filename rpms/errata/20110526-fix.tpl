...
'/software/packages'=pkg_repl('nss','3.12.8-3.el4','i386');
'/software/packages'=pkg_repl('nss','3.12.8-3.el4','x86_64');
...
'/software/packages'=pkg_repl('evolution28-pango','1.14.9-13.el4_10',PKG_ARCH_DEFAULT);
