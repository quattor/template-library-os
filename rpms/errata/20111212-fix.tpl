...
template rpms/errata/20111212-fix;
...
'/software/packages'=pkg_repl('nss','3.12.10-4.el4','i386');
'/software/packages'=pkg_repl('nss','3.12.10-6.el4','x86_64');
'/software/packages'=pkg_del('seamonkey-nspr');
'/software/packages'=pkg_repl('nspr','4.8.8-1.el4','i386');
'/software/packages'=pkg_repl('nspr','4.8.8-1.el4','x86_64');
...
'/software/packages'=pkg_repl('evolution28-pango','1.14.9-13.el4_11',PKG_ARCH_DEFAULT);
