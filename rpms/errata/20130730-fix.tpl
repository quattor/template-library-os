...
# Fix /etc/nsswitch dirperm issue
...
# kernel-module-ndiswrapper is no longer provided by recent kernels
'/software/packages' = pkg_del('kernel-module-ndiswrapper-' + KERNEL_VERSION_NUM + KERNEL_VARIANT);
