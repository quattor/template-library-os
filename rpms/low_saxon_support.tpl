...
unique template rpms/low_saxon_support;
...
"/software/packages"=pkg_repl("hunspell-nds","0.1-3.1.el6","noarch");
...
"/software/packages"=pkg_repl("kde-l10n-LowSaxon","4.3.4-5.el6","noarch");
