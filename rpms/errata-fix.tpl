...
'/software/packages'=pkg_ronly('apr','0.9.13-1','x86_64');
'/software/packages'=pkg_ronly('apr-devel','0.9.13-1','i386');
'/software/packages'=pkg_ronly('apr-devel','0.9.13-1','x86_64');
'/software/packages'=pkg_ronly('apr-util','0.9.13-1','x86_64');
'/software/packages'=pkg_ronly('apr-util','0.9.13-1','i386');
'/software/packages'=pkg_ronly('apr-util-devel','0.9.13-1','x86_64');
