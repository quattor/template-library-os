...
unique template rpms/backup_client;
...
"/software/packages"=pkg_repl("bacula-client","5.0.0-12.el6","x86_64");
"/software/packages"=pkg_repl("bacula-common","5.0.0-12.el6","x86_64");
