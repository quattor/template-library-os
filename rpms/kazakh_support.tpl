...
unique template rpms/kazakh_support;
...
"/software/packages"=pkg_repl("hunspell-kk","1.1-1.1.el6","noarch");
...
"/software/packages"=pkg_repl("kde-l10n-Kazakh","4.3.4-5.el6","noarch");
