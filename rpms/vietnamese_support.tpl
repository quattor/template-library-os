...
unique template rpms/vietnamese_support;


"/software/packages"=pkg_repl("autocorr-vi","3.4.5.2-16.1.el6_3","noarch");
...
"/software/packages"=pkg_repl("hunspell-vi","0.20080604-3.1.el6","noarch");
