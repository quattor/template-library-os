...
unique template rpms/belarusian_support;
...
"/software/packages"=pkg_repl("hunspell-be","1.1-1.1.el6","noarch");
"/software/packages"=pkg_repl("hyphen","2.4-5.1.el6","x86_64");
"/software/packages"=pkg_repl("hyphen-be","1.1-1.1.el6","noarch");
