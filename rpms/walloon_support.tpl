...
unique template rpms/walloon_support;
...
"/software/packages"=pkg_repl("hunspell-wa","0.4.15-4.1.el6","noarch");
...
"/software/packages"=pkg_repl("kde-l10n-Walloon","4.3.4-5.el6","noarch");
