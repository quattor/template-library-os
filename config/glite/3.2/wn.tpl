...
'/software/packages' = pkg_repl('libicu','3.6-5.16','i386');
...
# Atlas Requirements
'/software/packages' = pkg_repl('libxml2','2.6.26-2.1.2.8.el5_5.1','i386');
...
'/software/packages'=pkg_repl('libgfortran','4.1.2-50.el5','x86_64');

# Required by gLite 3.2 update 04
'/software/packages' = pkg_repl('python-ldap','2.2.0-2.1','x86_64');

# Required by superb
'/software/packages' = pkg_repl('yum-utils','1.1.16-14.sl5.1','noarch');
