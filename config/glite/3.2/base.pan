...
'/software/packages'=pkg_repl('libstdc++','4.1.2-54.el5',"i386");
'/software/packages'=pkg_repl('expat','1.95.8-11.el5_8',PKG_ARCH_GLITE);
'/software/packages'=pkg_repl('libstdc++','4.1.2-54.el5',PKG_ARCH_GLITE);
...
'/software/packages'=pkg_repl('libgcj','4.1.2-54.el5',PKG_ARCH_DEFAULT);
'/software/packages'=pkg_repl('libgcj-devel','4.1.2-54.el5',PKG_ARCH_DEFAULT);

'/software/packages'=pkg_repl('zlib','1.2.3-7.el5','i386');
...
'/software/packages' = pkg_repl('tcl','8.4.13-6.el5','i386');

'/software/packages' = pkg_repl('e2fsprogs-libs','1.39-35.el5','i386');
