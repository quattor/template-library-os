...
'/software/packages'=pkg_repl('nagios-plugins','1.4.14-3','x86_64');
'/software/packages'=pkg_repl('perl-Crypt-DES','2.05-3.2','x86_64');
'/software/packages'=pkg_repl('perl-Net-SNMP','5.2.0-1.2','noarch');
'/software/packages'=pkg_repl('perl-Socket6','0.22-1','x86_64');
