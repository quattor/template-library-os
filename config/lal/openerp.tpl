...
'/software/packages'=pkg_repl('postgresql','8.4.9-1.el6_1.1','x86_64');
'/software/packages'=pkg_repl('python-psycopg2','2.0.13-2.el6_1.1','x86_64');
...
'/software/packages'=pkg_repl('openssl','1.0.0-20.el6','x86_64');
...
'/software/packages'=pkg_repl('postgresql-server','8.4.9-1.el6_1.1','x86_64');
