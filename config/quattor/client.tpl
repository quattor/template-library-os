...
'/software/packages' = pkg_repl('perl-Compress-Raw-Zlib','2.020-127.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-IO-Compress-Base','2.020-127.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-IO-Compress-Zlib','2.020-127.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-Module-Pluggable','3.90-127.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-Pod-Escapes','1.04-127.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-Pod-Simple','3.13-127.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-version','0.77-127.el6',PKG_ARCH_DEFAULT);

# CCM 3.x dependencies
'/software/packages' = pkg_repl('perl-CGI','3.51-127.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-parent','0.221-127.el6',PKG_ARCH_DEFAULT);
