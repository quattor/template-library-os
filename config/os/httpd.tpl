...
"/software/packages"=pkg_repl("httpd-devel","2.2.3-63.sl5.1","x86_64");
"/software/packages"=pkg_repl("httpd-manual","2.2.3-63.sl5.1","x86_64");
"/software/packages"=pkg_repl("mod_auth_kerb","5.1-3.el5_7.1","x86_64");
...
'/software/packages'=pkg_repl('openldap-devel','2.3.43-25.el5','x86_64');
