...
"/software/packages"=pkg_repl("httpd-devel","2.2.3-45.sl5.1","x86_64");
"/software/packages"=pkg_repl("httpd-manual","2.2.3-45.sl5.1","x86_64");
...
"/software/packages"=pkg_repl("mod_nss","1.0.8-4.el5_6.1","x86_64");
...
# Dependencies
'/software/packages'=pkg_repl('apr-devel','1.2.7-11.el5_6.4','x86_64');
...
'/software/packages'=pkg_repl('expat-devel','1.95.8-8.3.el5_5.3','x86_64');
'/software/packages'=pkg_repl('openldap-devel','2.3.43-12.el5_6.7','x86_64');
