...
'/software/packages'=pkg_repl('postfix','2.3.3-2.1.el5_2','i386');
...
'/software/packages'=pkg_repl('cyrus-sasl-md5','2.1.22-5.el5','i386');

'/software/packages'=pkg_repl('pam_imap','0.3.8-2.el5.ircam','i386');
