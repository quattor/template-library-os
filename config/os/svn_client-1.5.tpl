# Template to update Subversion client to 1.5.x

template config/os/svn_client-1.5;

variable SUBVERSION_PKG_VERSION = '1.5.5-1';
...
# SVN dependencies provided by the OS (using standard version)
