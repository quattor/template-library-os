...
# Yaim dependencies
"/software/packages" = pkg_repl("redhat-lsb", "4.0-7.el6", PKG_ARCH_DEFAULT);
"/software/packages" = pkg_repl("redhat-lsb-core", "4.0-7.el6", PKG_ARCH_DEFAULT);
"/software/packages" = pkg_repl("redhat-lsb-compat", "4.0-7.el6", PKG_ARCH_DEFAULT);
"/software/packages" = pkg_repl("redhat-lsb-graphics", "4.0-7.el6", PKG_ARCH_DEFAULT);
"/software/packages" = pkg_repl("redhat-lsb-printing", "4.0-7.el6", PKG_ARCH_DEFAULT);
