...
'/software/packages'=pkg_repl('mod_ssl','2.2.15-28.sl6','x86_64');
...
# Yaim dependencies
'/software/packages' = pkg_repl('redhat-lsb', '4.0-3.el6', PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('redhat-lsb-graphics', '4.0-3.el6', PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('redhat-lsb-printing', '4.0-3.el6', PKG_ARCH_DEFAULT);
