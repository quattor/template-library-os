...
unique template config/emi/2.0/cream-ce;
...
"/software/packages"=pkg_repl("tomcat5","5.5.23-0jpp.37.el5","x86_64");
"/software/packages"=pkg_repl("tomcat5-common-lib","5.5.23-0jpp.37.el5","x86_64");
"/software/packages"=pkg_repl("tomcat5-jasper","5.5.23-0jpp.37.el5","x86_64");
...
"/software/packages"=pkg_repl("tomcat5-server-lib","5.5.23-0jpp.37.el5","x86_64");
...
"/software/packages"= if (ENABLE_MPI) {
  pkg_repl("mpi-selector","1.0.2-1.el5","noarch");
  pkg_repl("libibcm",'1.0.5-2.el5','x86_64');
  pkg_repl('libibverbs','1.1.6-3.el5','x86_64');
  pkg_repl('libnes','1.1.3-1.el5','x86_64');
  pkg_repl('librdmacm','1.0.15-2.el5','x86_64');
  pkg_repl('openib','1.5.4.1-4.el5','noarch');
