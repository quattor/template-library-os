...
"/software/packages"= if (ENABLE_MPI) {
  ...
  pkg_repl("libibcm",'1.0.5-1.el5','x86_64');
  pkg_repl('libibverbs','1.1.3-2.el5','x86_64');
  pkg_repl('libnes','0.9.0-2.el5','x86_64');
  pkg_repl('librdmacm','1.0.10-1.el5','x86_64');
  pkg_repl('openib','1.4.1-6.el5','noarch');
