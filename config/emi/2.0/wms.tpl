...
'/software/packages'=pkg_repl('gnutls-utils','1.4.1-7.el5_8.2','x86_64');
...
'/software/packages'=pkg_repl('libvirt','0.8.2-25.el5','x86_64');
...
'/software/packages'=pkg_repl('perl-suidperl','5.8.8-38.el5','x86_64');
'/software/packages'=pkg_repl('wsdl4j','1.5.2-4jpp.1','x86_64');
'/software/packages'=pkg_repl('xen-libs','3.0.3-135.el5_8.2','x86_64');
